...
Source Database       : qklaravel

Target Server Type    : MYSQL
Target Server Version : 50719
File Encoding         : 65001

Date: 2018-06-08 11:17:07
*/
...
CREATE TABLE `admin_app` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '触发行为的事件',
  `power` int(11) NOT NULL COMMENT '改行为奖励多少元力',
  `check_code` varchar(255) NOT NULL COMMENT '检测行为状态码',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='用户的资产主表';

-- ----------------------------
-- Records of admin_main_property
-- ----------------------------
INSERT INTO `admin_main_property` VALUES ('1', '1000006', '25.56250', '525', null, null, '2018-06-04 14:10:10', '2018-06-07 15:07:17');
INSERT INTO `admin_main_property` VALUES ('2', '1000007', '20.00000', '123', null, null, '2018-06-07 15:11:50', '2018-06-07 15:11:52');
INSERT INTO `admin_main_property` VALUES ('3', '1000008', '65.56650', '345', null, null, '2018-06-07 15:12:30', '2018-06-07 15:12:32');
...
-- ----------------------------
INSERT INTO `admin_power` VALUES ('1', '1000006', '1', '1', '1', '25', '2018-06-01 15:53:58', '2018-06-01 15:55:06', '22');
INSERT INTO `admin_power` VALUES ('2', '1000006', '1', '1', '1', '23', '2018-06-06 15:54:49', '2018-06-06 13:40:28', '22');
INSERT INTO `admin_power` VALUES ('3', '1000006', '1', '1', '1', '4', '2018-06-06 13:51:17', '2018-06-06 13:51:17', '26');
...
CREATE TABLE `admin_real_check` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='实名验证表';

-- ----------------------------
-- Records of admin_real_check
-- ----------------------------
INSERT INTO `admin_real_check` VALUES ('1', '1000006', '试试', '431025199010180012', '2018-06-06 14:40:27', '2018-06-06 14:40:27');
...
-- ----------------------------
INSERT INTO `admin_reception_users` VALUES ('1000006', '13711332408', null, '', '3O96', '13711332408', '1', null, '2', '2018-05-28 22:00:02', '2018-05-28 22:00:02', null);
INSERT INTO `admin_reception_users` VALUES ('1000007', '321', null, '', '3O97', '13711332408', '0', null, '2', '2018-05-28 22:04:29', '2018-05-28 22:04:29', null);
INSERT INTO `admin_reception_users` VALUES ('1000008', '441', null, '', '3O98', '13711332408', '0', null, '2', '2018-05-28 23:10:18', '2018-05-28 23:10:18', null);
...
CREATE TABLE `admin_stone` (
  ...
  `resid` int(11) NOT NULL DEFAULT '0' COMMENT '规则id',
  `actid` int(11) NOT NULL DEFAULT '0' COMMENT '行为id',
  `stone` float(11,5) NOT NULL DEFAULT '0.00000' COMMENT '点击的收入元石',
  `created_at` timestamp NULL DEFAULT NULL,
  `stone_balance` float(11,5) NOT NULL COMMENT '统计元力的总数',
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- ----------------------------
INSERT INTO `admin_stone` VALUES ('6', '1000006', '1', '1', '1', '40.00000', '2018-06-01 15:20:15', '40.00000', '2018-06-01 17:16:53');
INSERT INTO `admin_stone` VALUES ('7', '1000006', '1', '1', '1', '-10.00000', '2018-06-02 15:34:16', '30.00000', '2018-06-01 19:37:42');
INSERT INTO `admin_stone` VALUES ('8', '1000006', '1', '1', '1', '99997.50000', '2018-06-06 13:35:44', '100027.50000', '2018-06-06 13:35:44');
INSERT INTO `admin_stone` VALUES ('9', '1000006', '1', '1', '1', '99997.50000', '2018-06-07 15:04:25', '200025.00000', '2018-06-07 15:04:25');
INSERT INTO `admin_stone` VALUES ('10', '1000006', '1', '1', '1', '99997.50000', '2018-06-07 15:04:40', '300022.50000', '2018-06-07 15:04:40');
INSERT INTO `admin_stone` VALUES ('11', '1000006', '1', '1', '1', '79999.00000', '2018-06-07 15:06:09', '380021.50000', '2018-06-07 15:06:09');
INSERT INTO `admin_stone` VALUES ('12', '1000006', '1', '1', '1', '79999.00000', '2018-06-07 15:06:20', '460020.50000', '2018-06-07 15:06:20');
INSERT INTO `admin_stone` VALUES ('13', '1000006', '1', '1', '1', '79999.00000', '2018-06-07 15:06:45', '540019.50000', '2018-06-07 15:06:45');
INSERT INTO `admin_stone` VALUES ('14', '1000006', '1', '1', '1', '79999.00000', '2018-06-07 15:07:17', '620018.50000', '2018-06-07 15:07:17');
...
CREATE TABLE `admin_stone_total` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `total_stone` decimal(16,5) NOT NULL COMMENT '元石总产值',
  `day_stone` varchar(10) NOT NULL COMMENT '昨日产生元石',
  `remain_stone` decimal(16,5) NOT NULL COMMENT '剩余的元石量',
  `Reserved` decimal(11,5) DEFAULT NULL COMMENT '待领取元石',
  `created_at` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='元石总量表';

-- ----------------------------
-- Records of admin_stone_total
-- ----------------------------
INSERT INTO `admin_stone_total` VALUES ('1', '5000000000.00000', '10', '4999000000.00000', null, '2018-06-05 21:38:10', '2018-06-05 21:38:10');
...
-- ----------------------------
INSERT INTO `admin_visit` VALUES ('6', '1000006', '::1', '1adc746d856f69bb17f8bac6dca35d70', '2018-06-05 22:00:02', '2018-06-07 19:30:03');
INSERT INTO `admin_visit` VALUES ('7', '1000007', '::1', '9b94f12d859426b40eb31bff5d7fe5f9', '2018-05-28 22:04:29', '2018-06-06 18:52:56');
